...
def build_regex_from_schema(
    json: str, whitespace_pattern: Optional[str] = None, max_recursion_depth: Optional[int] = None
) -> str: ...
def to_regex(json: Dict, whitespace_pattern: Optional[str] = None, max_recursion_depth: Optional[int] = None) -> str: ...
def _walk_fsm(
